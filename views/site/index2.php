...
<div class="row">
    <div class="col-md-3 col-sm-6 col-xs-12">
        <?= InfoBox::widget([
            'text' => 'CPU TRAFFIC',
            'number' => '90%',
            'icon' => Html::ion('ios-gear-outline')
        ]) ?>
    </div>
    ...
    <div class="col-md-3 col-sm-6 col-xs-12">
        <?= InfoBox::widget([
            'bg' => 'bg-green',
            'icon' => Html::ion('ios-cart-outline'),
            'text' => 'SALES',
            'number' => '760',
        ]) ?>
    </div>
    ...
    <div class="col-md-3 col-sm-6 col-xs-12">
        <?= InfoBox::widget([
            'bg' => 'bg-yellow',
            'icon' => Html::ion('ios-people-outline'),
            'text' => 'NEW MEMBERS',
            'number' => '2,000',
        ]) ?>
    </div>
...
<div class="row">
    ...
    <div class="col-md-4">
        <?= InfoBox::widget([
            'bg' => 'bg-yellow',
            'bgFill' => true,
            'icon' => Html::ion('ios-pricetag-outline'),
            'text' => 'INVENTORY',
            'number' => '5,200',
            'progress' => '50',
        ...
        <?= InfoBox::widget([
            'bg' => 'bg-green',
            'bgFill' => true,
            'icon' => Html::ion('ios-heart-outline'),
            'text' => 'MENTIONS',
            'number' => '92,050',
            'progress' => '20',
        ...
        <?= InfoBox::widget([
            'bg' => 'bg-red',
            'bgFill' => true,
            'icon' => Html::ion('ios-cloud-download-outline'),
            'text' => 'DOWNLOADS',
            'number' => '114,381',
            'progress' => '70',
        ...
        <?= InfoBox::widget([
            'bg' => 'bg-aqua',
            'bgFill' => true,
            'icon' => Html::ion('ios-chatbubble-outline'),
